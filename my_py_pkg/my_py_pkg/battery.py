...
class BatteryNode(Node): 
    ...
    def get_current_time_seconds(self):
        ...
        #self.get_logger().info("show me the time secs:" + str(secs) + " and nsecs" + str(nsecs))
        second = secs + (nsecs/1000000000.0)
        return second
    ...
    def call_set_led_server(self, led_number, state):
        ...
        while not client.wait_for_service(1.0):
            self.get_logger().warn("waiting for service serve Set Led...")
    ...
    def callback_call_set_led(self,future,led_number,state):
        try:
            ...
            self.get_logger().info("response success:" + str(response.success))
